...
<div class="container">
	...
	<?php
		...
		!empty($zerif_copyright)):
					...
					echo '<div class="zerif-copyright-box">Derechos Reservados a '.__('','').'<a class="zerif-copyright" href="http://ipmaslan.com/" target="_blank" rel="nofollow">IPM ASLAN CA</a></div>';
