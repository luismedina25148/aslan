...
function match_credits_designer() {
	$credit = 'http://dovethemes.com/match/';
	echo apply_filters( 'match_credits_designer', '<div class="credits-designer"><a href="'. $credit .'">Wedding WordPress Theme</a> &sdot; <a href="http://dovethemes.com/">DoveThemes</a></div>' );
}
